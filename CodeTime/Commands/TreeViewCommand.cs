...
namespace CodeTime
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class TreeViewCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private TreeViewCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static TreeViewCommand Instance
        {
            get;
            private set;
        }
        ...
        public static async System.Threading.Tasks.Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new TreeViewCommand(package, commandService);
        }
        ...
        private static void Execute(object sender, EventArgs e)
        {
            ...
            {
                LogManager.Error("Error launching the code metrics view", ex);
            }
        }
    }
}
